...
case 9:
#line 158 "pc.y"
	{yyval.tval = strTree(INUM, "INUM TYPE", emptyTree(), emptyTree());}
break;
case 10:
#line 160 "pc.y"
	{ yyval.tval = strTree(RNUM, "RNUM TYPE", emptyTree(), emptyTree());}
break;
case 11:
#line 165 "pc.y"
...
#line 304 "pc.y"
	{
			...
			checkArgs(top_scope, yystack.l_mark[-3].tval, yystack.l_mark[-1].tval);
